export default async function handler(req, res) {
  ...
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #1a1a1a; color: white; padding: 40px; border-radius: 10px; text-align: center;">
        ...
        <a href="https://scentiamx.mitiendanube.com/" style="background-color: #ffffff; color: #000000; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">IR A LA TIENDA</a>
    </div>
  `;
